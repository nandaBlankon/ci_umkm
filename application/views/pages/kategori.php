        ...
        <div class="container position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active breadcrumb-light" aria-current="page">Kategori</li>
                </ol>
            </nav>
            <h1 class="fw-bold display-6 mb-4 text-white"><?= ucwords($kategori->nama_kategori); ?></h1>
        </div>
    </div>
    <!-- Category Top Banner -->
        ...
        <div class="row">
                        ...
                        <div class="mb-4">
                            ...
                            <nav>
                                <ul class="list-unstyled list-default-text">
                                    ...
                                    <li class="mb-2"><a class="text-decoration-none text-body text-secondary-hover transition-all d-flex justify-content-between align-items-center" href="<?= base_url('seller/umkm'); ?>"><span><i class="ri-arrow-right-s-line align-bottom ms-n1"></i> Home Industri</span> <span class="text-muted ms-4">(<?= $homeIndustri->num_rows(); ?>)</span></a>
                                    </li>
                            ...
                            <div id="filter-brands" class="collapse show">
                                ...
                                <div class="simplebar-wrapper">
                                    <div class="filter-options" data-pixr-simplebar>
                                        ...
                                        <?php
                                        $cats = $this->db->query("select * from tb_kategori where id_kategori != '$kategori->id_kategori'");
            ...
            <div class="col-12 col-lg-9">
                ...
                <div class="row g-4 mb-5">
                    <?php
                    $produk = $this->db->query("select * from tb_produk where id_kategori='$kategori->id_kategori'");
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        <span class="small text-uppercase tracking-wide fw-bolder text-center d-block"><?= $kategori->nama_kategori; ?></span>
                                ...
                                <div class="card-body px-0 text-center">
                                    ...
                                    <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center" href="<?= base_url('product/' . $data->slug); ?>"><?= ucfirst($data->judul); ?></a>
